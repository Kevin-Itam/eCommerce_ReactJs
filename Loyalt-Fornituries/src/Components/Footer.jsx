        ...
        <div className="py-20">
            ...
            <div className="flex flex-col gap-6">
                ...
                <li className="group border border-slate-600 rounded py-4 px-10 transition-transform duration-300 ease-in-out hover:-translate-y-1">
                    <a className="flex flex-col gap-4 items-center transition-colors duration-300 group-hover:text-gray-400" href="#"><FontAwesomeIcon icon={faGithub} size='2x'/><p className='text-white'>GitHub</p></a></li>
                <li className="group border border-slate-600 rounded py-4 px-10 transition-transform duration-300 ease-in-out hover:-translate-y-1">
                    <a className="flex flex-col gap-4 items-center transition-colors duration-300 group-hover:text-blue-500" href="#"><FontAwesomeIcon icon={faLinkedin} size='2x'/><p className='text-white'>Linkdin</p></a></li>
                <li className="group border border-slate-600 rounded col-span-2 py-5 px-10 transition-transform duration-300 ease-in-out hover:-translate-y-1">
                    <a className="flex flex-col gap-4 justify-center items-center transition-colors duration-300 group-hover:text-green-500" href="#"><FontAwesomeIcon icon={faWhatsapp} size='2x'/><p className='text-white'>Instagram</p></a></li>
                </ul>
            </div>
            </div>
        </div>
